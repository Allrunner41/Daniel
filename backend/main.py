...
HF_MODEL = os.environ.get("HF_MODEL", "Frederic/french-chatgpt-detector")
HF_ROUTER_URL = f"https://api-inference.huggingface.co/models/{HF_MODEL}"
...
def _parse_hf_output(raw: object) -> Tuple[float, float]:
    ...
    for item in scores:
        ...
        elif any(k in label for k in ("real", "human", "label_0", "original")):
            human_prob = score
